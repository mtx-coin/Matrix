...
This mechanism has been integrated into Bitcore-Node-MATRIX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/matrixpay/insight-api-matrix#web-socket-api](https://github.com/matrixpay/insight-api-matrix#web-socket-api)
* API: [https://github.com/matrixpay/insight-api-matrix#instantsend-transactions](https://github.com/matrixpay/insight-api-matrix#instantsend-transactions)
...
By default, the MATRIX Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MATRIX Core daemon:
